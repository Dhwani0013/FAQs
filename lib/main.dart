...
class SIForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Container(child:Text("Que. Who is this app for?",
    textDirection: TextDirection.ltr,
    style: TextStyle(
    decoration: TextDecoration.none,
    fontSize: 20.0,
    ...
    Container(child:Text("Que. How this app is useful?",
    textDirection: TextDirection.ltr,
    style: TextStyle(
    decoration: TextDecoration.none,
    fontSize: 20.0,
    ...
    color: Colors.black
      ...
      Container(child:Text("With detailed information on 1200s of diseases and probable prescription drug ingo,this app is a free medical encyclopedia guide.\n",
        textDirection: TextDirection.ltr,
        style: TextStyle(
            decoration: TextDecoration.none,
            fontSize: 18.0,
      ...
      Container(child:Text("Que. Which devices can I use?",
        textDirection: TextDirection.ltr,
        style: TextStyle(
            decoration: TextDecoration.none,
            fontSize: 20.0,
      ...
      Container(child:Text("Que. How it is different from other medical dictionary app?",
        textDirection: TextDirection.ltr,
        style: TextStyle(
            decoration: TextDecoration.none,
            fontSize: 20.0,
      ...
      Container(child:Text("Que. Why can't I hear the audio pronunciations?",
        textDirection: TextDirection.ltr,
        style: TextStyle(
            decoration: TextDecoration.none,
            fontSize: 20.0,
      ...
      Container(child:Text("Que. Why use apps when I can use Google?",
        textDirection: TextDirection.ltr,
        style: TextStyle(
            decoration: TextDecoration.none,
            fontSize: 20.0,
      ...
      Container(child:Text("Note : If you have any query related to our app then you can contact us on dhwani1896@gmail.com.We try to respond as quickly as possible,but it may take a while.",
        textDirection: TextDirection.ltr,
        style: TextStyle(
            decoration: TextDecoration.none,
            fontSize: 18.0,
